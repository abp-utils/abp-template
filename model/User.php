...
class User extends UserSchema
{
    ...
    {
        $this->token = Security::generateHash($this->token);
        $this->hash = Security::generateHashWithSalt($this->hash);
        return parent::beforeSave($isNewRecord); // TODO: Change the autogenerated stub
    }
